            ...
            if delegate.quitMode == .holdToQuit {
                HStack {
                    ...
                    Picker("", selection: Binding(
                        ...
                        Text(L10n.string("duration.0.5_seconds", defaultValue: "0.5s")).tag(QuitProtectSettingsPolicy.holdDurations[0])
                        Text(L10n.string("duration.1.0_seconds", defaultValue: "1.0s")).tag(QuitProtectSettingsPolicy.holdDurations[1])
                        Text(L10n.string("duration.1.5_seconds", defaultValue: "1.5s")).tag(QuitProtectSettingsPolicy.holdDurations[2])
                        Text(L10n.string("duration.2.0_seconds", defaultValue: "2.0s")).tag(QuitProtectSettingsPolicy.holdDurations[3])
                    }
                    .labelsHidden()
                    .fixedSize()
                }
            ...
            if delegate.quitMode == .doublePress {
                HStack {
                    ...
                    Picker("", selection: Binding(
                        ...
                        Text(L10n.string("duration.0.3_seconds", defaultValue: "0.3s")).tag(QuitProtectSettingsPolicy.doublePressIntervals[0])
                        Text(L10n.string("duration.0.4_seconds", defaultValue: "0.4s")).tag(QuitProtectSettingsPolicy.doublePressIntervals[1])
                        Text(L10n.string("duration.0.5_seconds", defaultValue: "0.5s")).tag(QuitProtectSettingsPolicy.doublePressIntervals[2])
                        Text(L10n.string("duration.0.75_seconds", defaultValue: "0.75s")).tag(QuitProtectSettingsPolicy.doublePressIntervals[3])
                    }
                    .labelsHidden()
                    .fixedSize()
                }
